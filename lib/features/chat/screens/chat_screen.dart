            ...
            child: Row(
              children: [
                ...
                const Column(
                  ...
                  children: [
                    Text(AppStrings.supportAgentName, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.secondary)),
                    Text(AppStrings.activeStatus, style: TextStyle(fontSize: 11, color: AppColors.success)),
                  ],
                ),
              ],
            ),
