...
class _OrderSuccessScreenState extends State<OrderSuccessScreen>
  ...
  Widget build(BuildContext context) {
    final orderIdStr = widget.order != null
        ...
        children: [
          ...
          Column(
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    FadeTransition(
                      opacity: _fade,
                      child: const Text(AppStrings.orderSuccessTitle,
                    ...
                    FadeTransition(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            const Text(AppStrings.orderCode,
                                style: TextStyle(
                                    fontSize: 11,
                                    color: AppColors.mutedForeground)),
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(AppSizes.p24, 0, AppSizes.p24,
                    AppSizes.p32 + MediaQuery.of(context).padding.bottom),
                child: Column(
                  children: [
                    AppButton(
                      ...
                      onPressed: () => Navigator.pushReplacement(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                OrderDetailScreen(orderId: orderIdStr),
                          )),
                    ),
